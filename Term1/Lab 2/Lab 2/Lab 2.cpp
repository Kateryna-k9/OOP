...
int main() {
    ...
    float nominal1, nominal2, nominal3;
    int qty1, qty2, qty3;
    ...
    scanf("%19s %c %f %d", poz1, &type1, &nominal1, &qty1);

    printf("2. Введіть: Позначення, Тип, Номінал, Кількість > ");
    scanf("%19s %c %f %d", poz2, &type2, &nominal2, &qty2);
